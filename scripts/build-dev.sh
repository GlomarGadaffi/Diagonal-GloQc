#!/bin/bash
# Build the capture daemon from source for development.
...
case "$COMMAND" in
    build)
        ...
        echo "  target/armv7-unknown-linux-musleabihf/firmware-devel/rayhunter-daemon"
        echo "  target/armv7-unknown-linux-musleabihf/firmware-devel/rootshell"
        echo "Deploy with make.sh or adb push, per your device's install method."
        echo ""
